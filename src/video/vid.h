...
public:
	...
	virtual void DrawToVid(const SPRITE* p_sprite, const VID_TEXCOOR* p_texCoor,
		TEXTURE* p_texture, TEXTURE* p_zTexture); // vtable+0x14
	...
	union { // 0x250
		int m_aniChildVid[17];
		struct {
			int m_unk0x250[8]; // 0x250
			VID* m_weaponVid; // 0x270
			undefined m_unk0x274[0x10]; // 0x274
			VID* m_unk0x284; // 0x284
			undefined m_unk0x288[0x8]; // 0x288
			int m_unk0x290; // 0x290
		};
	};
...
#ifdef DECOMP_INLINE_VID_ENTITIES_NUMBER_TOTAL
